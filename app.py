...
def health():
	...
	return make_response(jsonify({
		'service_search':{
			...
			'API_elasticsearch':'To_Be_Implemented',
			'micro_product':x['micro_product_flag'],
		}}),200)

@app.route('/api/search/SomeRoute', methods=['GET'])
@app.route('/api/search/SomeRoute', methods=['POST'])
@app.route('/api/search/SomeRoute', methods=['PUT'])
@app.route('/api/search/SomeRoute', methods=['DELETE'])
